...
<!-- 	<div class="logo">
	...
	<div id = "box-wrapper">
		<div class="footer-box">
			<p id="footer-label">Get To Know Us</p>
			<p id="footer-clickable">Careers</p>
			<p id="footer-clickable">Investor Relations</p>
			<p id="footer-clickable">Partners</p>
		</div>
		<div class="footer-box">
			<p id="footer-label">Let Us Help You</p>
			<p id="footer-clickable">Your account</p>
			<p id="footer-clickable">Your Order</p>
			<p id="footer-clickable">Your Likes</p>
			<p id="footer-clickable">Help</p>
		</div>
		<div class="footer-box">
